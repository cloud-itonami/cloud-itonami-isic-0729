# Operator Quickstart — Non-Ferrous Metal Ore Mining Operations Coordinator

Shortest path from clone to a verified local dry-run for **ISIC 0729** (`cloud-itonami-isic-0729`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0729.git
cd cloud-itonami-isic-0729
```
...
- Blueprint governor key: `nonferrous-ore-governor`
- Likely source path: `nonferrousops.governor.cljc`
