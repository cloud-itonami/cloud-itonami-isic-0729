# Business Model: Non-Ferrous Metal Ore Mining Operations Coordinator
...
## Classification
- Repository: `cloud-itonami-isic-0729` ([github.com/cloud-itonami/cloud-itonami-isic-0729](https://github.com/cloud-itonami/cloud-itonami-isic-0729))
- ISIC Rev.5: `0729` — Non-Ferrous Metal Ore Mining Operations Coordinator
- Domain: `:mining/nonferrous-ore`
- Social impact: :resource-stewardship :mine-safety :supply-resilience
- Actor: `:nonferrous-ore-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :mining/nonferrous-ore — who wants
a governed execution scaffold they own instead of renting a closed SaaS.

## Offer
The actor coordinates the :intake :survey :extract :grade :ship :audit pipeline behind an independent Governor: the
...
One managed tenant (:mining/nonferrous-ore):
...
- Do not bypass the `:nonferrous-ore-governor` for production decisions.
